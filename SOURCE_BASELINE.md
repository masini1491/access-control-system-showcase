# Showcase Source Baseline

此公開 repository 為 `masini1491/access-control-system` 的展示／技術文件版本，不包含 private firmware source。

| 項目 | 基準 |
|---|---|
| Private source repository | `masini1491/access-control-system` |
| Source branch | `main` |
| Private source baseline | `5cb9c42b2934b07aa2b9eb614299ff9cbaf838b9` |
